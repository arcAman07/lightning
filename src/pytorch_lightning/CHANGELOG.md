...
- Deprecated `pytorch_lightning.utilities.distributed.tpu_distributed` in favor of `TPUAccelerator.is_available` ([#14550](https://github.com/Lightning-AI/lightning/pull/14550))

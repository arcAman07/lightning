...
def test_cluster_logs_reader_pagination():
    ...
    assert logs_api_client.create_cluster_logs_socket.call_args_list[1].kwargs["start"] == 1661821079
    ...
    assert len(logs_api_client.create_cluster_logs_socket.call_args_list) == 2

...
from pytorch_lightning.accelerators.tpu import _multi_process, _XLA_AVAILABLE, TPUAccelerator
...
@patch("pytorch_lightning.accelerators.tpu.TPU_CHECK_TIMEOUT", 3)
...
def test_result_returns_within_timeout_seconds():
    ...
    start = time.time()
    from pytorch_lightning.accelerators.tpu import TPU_CHECK_TIMEOUT
